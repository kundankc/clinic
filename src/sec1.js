                 ...
                 <div className="container">
                     <div className="row">
                         ...
                         <div className="col-lg-7 col-12">
                             <div className="hero-text">
                                 <div className="hero-title-wrap d-flex align-items-center mb-4">
                                     <img src="/images/happy-bearded-young-man.jpg" className="avatar-image avatar-image-large img-fluid" />
                         ...
                         <div className="col-lg-5 col-12 position-relative">
                             ...
                             <img src="images/portrait-happy-excited-man-holding-laptop-computer.png" className="hero-image img-fluid" />
                         </div>
